...
export class VisionService {
    ...
    async analyzeImage(imageBuffer) {
        ...
        try {
            ...
            const [result] = await this.executeWithRetry(() => this.client.annotateImage(request));
            if (!result) {
     ...
     */
    async analyzeImagesBatch(imageBuffers, concurrency = 3) {
    ...
    processImageProperties(properties) {
